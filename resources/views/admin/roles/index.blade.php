            ...
            <div class="row justify-content-center">
                <div class="col-12">
                    <div class="card shadow-2-strong tab-1">
                        <div class="card-body  h-card mt-5">
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <ul class="dropdown-menu " aria-labelledby="dropdownMenuButton">
                                                        ...
                                                        <li>
                                                                    ...
                                                                    <form method="POST" action="{{ route('roles.destroy', $role->id) }}"  id="add_form">
                                                                        @csrf
                                                                       
                                                                        <input type="hidden" name="id"
                                                                            value="{{ $role->id }}">
                                                                        <button type="submit" data-form-id="#delete_form_{{$role->id}}" class="dropdown-item h4 text-dark mx-1 delete_btn"><i class="bi-trash h4"></i>Delete
                                                                            </button>
                                                                    </form>
