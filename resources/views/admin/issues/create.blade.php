...
@section('main-section')
    <div class="container">
        <form action="{{ route('issues.store') }}" method="POST" id="add_form" enctype="multipart/form-data">
            <div class="row m-2">
                <div class="col-lg-10 col-7 mt-3">
                    <a href="{{ route('issues.index') }}" style="margin-left: -20px"><i class="bi bi-arrow-left"></i> Back
                        To issues</a>
                </div>
            ...
            <div class="card shadow mt-3">
                ...
                <div class="container p-3 mt-3  mb-5  col-lg-9">
                    <h2 class="card-title">Add New Issue</h2>
                    <div class="row ">
